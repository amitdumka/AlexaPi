...
ALEXASRC_DIRECTORY_CORRECT="/cybern/AlexaPi/src"

CONFIG_SYSTEM_DIRECTORY="/etc/cybern/AlexaPi"
...
if [ "$ALEXASRC_DIRECTORY" != "$ALEXASRC_DIRECTORY_CORRECT" ]; then
    ...
    echo "You haven't downloaded AlexaPi into /cybern. As a result of that, you won't be able to run AlexaPi on boot."

    echo "If you wish to be able to run AlexaPi on boot, please interrupt this script and download into /cybern."
    ...
    case ${interrupt_script} in
            ...
            * )
                ...
                echo "Script interrupted. Please download AlexaPi into /cybern as in project documentation."
